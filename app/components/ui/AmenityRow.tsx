    ...
    >
      {amenities.map((amenity: IAmenity) => (
        ...
        <View key={amenity.name} style={{ paddingLeft: 4 }}>
          ...
          {amenity.name === 'Wheelchair Accessible' && (
            <FontAwesome5 name="wheelchair" size={size - 4} color={color} />
          )}
          {amenity.name === 'Wheelchair Lift' && (
            <FontAwesome5 name="wheelchair" size={size - 4} color={color} />
          )}
          {amenity.name === 'Bicycle Rack' && (
            <MaterialIcons name="pedal-bike" size={size + 4} color={color} />
          )}
          {amenity.name === 'Shelter' && (
            <MaterialCommunityIcons
